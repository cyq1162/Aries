...
if(opts.multiple){
if(_623){
$(_622).combobox("setValues",_623.toString().split(opts.separator));
}else{
$(_622).combobox("clear");
}
}else{
...
opts.onSelect.call(_6ee,$.data(_6ee,"treegrid").data);
