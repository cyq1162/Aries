...
function thumbnailsContainer(value, rec) {
    ...
    if (isImg) {
        return '<div class="operation w1">' +
              ...
              '<a class="cktp centerA" title="查看缩略图"  onclick="TY.Utility.Window.open(\'/Ajax/FileUpload.ashx?method=GetImage&mid=' + mid + '&fileId=' + rec.FileID + '\',\'' + rec.FileName + '\',false,{width:800,height:500,fit:false,maximizable:true})"></a>' +
                '</div>';
    }
    else {
        return '<div class="operation w1">' +
...
(function () {
    TY.Utility.loadCss("/Style/JS/UploadPlugin/swfupload/swfUpload.css");
    TY.Utility.loadJs("/Style/JS/UploadPlugin/swfupload/swfupload.js");
    TY.Utility.loadJs("/Style/JS/UploadPlugin/swfupload/swfupload.queue.js");
    TY.Utility.loadJs("/Style/JS/UploadPlugin/swfupload/fileprogress.js");
    TY.Utility.loadJs("/Style/JS/UploadPlugin/swfupload/handlers_v2.0.js");
    TY.Utility.loadJs("/Style/JS/UploadPlugin/swfupload/swfupload.cookies.js");
    TY.FileUpload = {
        items: [],
        ...
        */
        ...
        function startUpload() {
            if (Obj.selFileType.val() == "") {
                TY.Utility.Window.showMsg("请选择一个文件类型");
                return false
            };
        ...
        function initGrid() {
            if (Obj.businesskey) {
                ...
                Obj.DataGrid = new TY.DataGrid("PB_File", "PB_File", Obj.id);
                ...
                TY.Utility.Window.showMsg('由于业务主键未设置导致文件上传控件加载失败...');
            }
        }
