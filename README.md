...
二：关于商用：
1：未向作者登陆信息的个人或企业，不得商用。
2：在框架未明确表示收费之前，已经向作者登陆记了个人或企业信息的用户，可免费商用。
3：若框架明确表示后续版本收费，已登记的用户仍可免费使用之前的版本。
登记方式：
1：联系作者QQ：272657997，提交信息。
2：发送以下内容信息到邮箱：27265799@qq.com
企业信息为：企业完整名字、企业网址、企业工商号。
个人信息为：名字：身份证号。
